...
/>
      ...
      <div className="relative w-[623.46px] h-[272.1px] left-[20px]">
        <h3 className="font-heebo font-bold text-[30px] leading-[44.06px] w-[305px] h-[44px]">
        Designing Dashboards
        </h3>
        <div className="flex">
        <div className="absolute w-[68px] h-[24px] top-[52.9px] left-[3.46px] rounded-[50px] bg-customPink">
